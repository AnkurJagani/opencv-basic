package org.ankur.opencvproject;
...
public class MainActivity extends AppCompatActivity  implements View.OnTouchListener, CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    private void checkRequiredPermission() {
        requiredPermission = ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED;
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == 121) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(this, "Permission needs to be provided", Toast.LENGTH_SHORT).show();
            }
        }
    }

    private void onRequiredPermissionGranted() {
